...
namespace UserMenus\Rules;

defined( 'ABSPATH' ) || exit;

use function UserMenus\Rules\allowed_user_roles;
use function UserMenus\Rules\is_post_type;
use function UserMenus\Rules\get_rule_option;
use function UserMenus\Rules\get_rule_extra;
...
function content_is_home_page() {
	...
	if ( 'user_menus/should_hide_block' === \current_filter() ) {
