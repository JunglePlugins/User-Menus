...
function content_has_restrictions( $post_id = null ) {
	 ...
	 * @return bool
	 */
	return (bool) apply_filters( 'user_menus/content_has_restriction', $has_restrictions, $post_id );
}
 ...
 *
 * @param int|null $post_id Post ID.
 * @return \UserMenus\Restrictions\Restriction|false
 */
...
function user_can_view_content( $post_id = null ) {
	 ...
	 * @return bool
	 */
	return (bool) apply_filters( 'user_menus/user_can_view_content', $can_view, $post_id );
}
...
function content_is_restricted( $post_id = null ) {
	 ...
	 * @return bool
	 */
	return (bool) apply_filters( 'user_menus/content_is_restricted', $is_restricted, $post_id );
}
