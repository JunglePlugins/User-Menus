...
use function UserMenus\protection_is_disabled;
...
class Posts extends Controller {
	...
	public function the_content( $content ) {
		$filter_name = 'user_menus/post_restricted_content';
	...
	public function get_the_excerpt( $post_excerpt, $post ) {
		$filter_name = 'user_menus/post_restricted_excerpt';
