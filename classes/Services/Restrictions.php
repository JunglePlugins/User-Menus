...
use \UserMenus\Models\Restriction;
...
class Restrictions {
	...
	/**
	 * Cache to prevent rechecks & queries.
	 *
	 * @var array
	 */
	private $cache = [];
	...
	public function get_restrictions() {
		...
		if ( ! isset( $all_restrictions ) ) {
			...
			if ( \UserMenus\get_data_version( 'restrictions' ) === 1 ) {
				$restrictions = \UserMenus\get_v1_restrictions();
	 ...
	 *
	 * Careful, this could be very unfunctional if you have a lot of restrictions.
	 *
	 * @return array
	 */
