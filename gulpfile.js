...
gulp.task('js:admin', function() {
    return gulp.src(['assets/scripts/src/admin/vendor/*.js', 'assets/scripts/src/admin/plugins/**/*.js', 'assets/scripts/src/admin/general.js'])
...
gulp.task('js:site', function() {
    return gulp.src(['assets/scripts/src/site/plugins/**/*.js', 'assets/scripts/src/site/general.js'])
        .pipe($fn.plumber(plumberErrorHandler))
        .pipe($fn.jshint())
        .pipe($fn.jshint.reporter('default'))
        .pipe($fn.order([
...
gulp.task('clean-js:site', function () {
    return gulp.src('assets/scripts/site*.js', {read: false})
        .pipe($fn.plumber(plumberErrorHandler))
        .pipe($fn.clean());
});
gulp.task('clean-js:admin', function () {
    return gulp.src('assets/scripts/admin*.js', {read: false})
        .pipe($fn.plumber(plumberErrorHandler))
        .pipe($fn.clean());
});
gulp.task('clean-js:other', function () {
    return gulp.src(['assets/scripts/*.js', '!assets/scripts/site*.js', '!assets/scripts/admin*.js'], {read: false})
        .pipe($fn.plumber(plumberErrorHandler))
        .pipe($fn.clean());
});
gulp.task('clean-css', function () {
    return gulp.src(['assets/styles/*.css', 'assets/styles/*.css.map'], {read: false})
        .pipe($fn.plumber(plumberErrorHandler))
        .pipe($fn.clean());
});
...
gulp.task('watch', function () {
    ...
    gulp.watch(['assets/scripts/src/**/*.js', '!assets/scripts/src/site/**/*.js', '!assets/scripts/src/admin/**/*.js'], ['js:other']);
...
gulp.task('build', ['prebuild'], function () {
    return gulp.src(['./**/*.*', '!./build/**', '!./release/**', '!./node_modules/**', '!./gulpfile.js', '!./package.json', '!./assets/scripts/src/**'])
        .pipe($fn.plumber(plumberErrorHandler))
